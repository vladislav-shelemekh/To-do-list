...
// const StyledAppBlock = styled(AppBlock)` // create a new component with inner styles from AppBlock
...
export default class App extends Component {
    constructor(props) {
        ...
        this.state = {
            data: [
                {label: 'Не вмерла Украина', important: false, like: false, id: 1},
                {label: 'Вмерла Украина', important: false, like: false, id: 2},
                {label: 'Ще не вмерла Украина', important: false, like: false, id: 3}
            ],
            term: '',
            filter: 'all'
        };
